...
let ChipList = class ChipList extends LitElement {
    constructor() {
        super(...arguments);
        this.icon = '';
        this.all = [];
    ...
    getSelectedItems() {
        return html `${Array.from(this.selectedSet).map((item) => html ` <fwc-chip
            icon="${this.icon}"
            text="${item.name}"
...
__decorate([
    query('mwc-menu')
], ChipList.prototype, "menu", void 0);
__decorate([
    query('.input')
], ChipList.prototype, "input", void 0);
__decorate([
    property({ type: String })
], ChipList.prototype, "icon", void 0);
__decorate([
    property({ type: Array })
], ChipList.prototype, "all", void 0);
__decorate([
    state()
], ChipList.prototype, "additional", void 0);
__decorate([
    state()
], ChipList.prototype, "selectedSet", void 0);
ChipList = __decorate([
