...
declare const formatDate: (timestamp?: number | undefined, formatStr?: string) => string;
declare const formatDateTime: (timestamp?: number | undefined, formatStr?: string) => string;
